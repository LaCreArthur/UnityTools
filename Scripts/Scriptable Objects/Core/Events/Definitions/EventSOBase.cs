...
namespace Toolbox.ScriptableObjects.Events
{
        ...
        where T : UnityEventBase
    {
        ...
        {
            if (listeners == null) listeners = new List<ReferencedEvent<T>>();
        ...
        public void RemoveListener(ReferencedEvent<T> uEvent)
        {
            ...
            var ultListener = listeners.Find(l => l.reference == uEvent.reference && Equals(l.callbacks, uEvent.callbacks));
            listeners.Remove(ultListener);
        }
