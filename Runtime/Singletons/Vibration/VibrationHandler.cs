...
namespace AS.Toolbox.Singletons.Vibration
{
    public class VibrationHandler : MonoBehaviour
    {
        ...
        public static void TransientHaptic(float intensity, float sharpness, bool alsoRumble, MonoBehaviour coroutineSupport,
            int controllerID)
        {
#if MOREMOUNTAINS_NICEVIBRATIONS
        ...
        public static void TransientHaptic(bool vibrateiOS, float iOSIntensity, float iOSSharpness, bool vibrateAndroid,
            float androidIntensity,
            float androidSharpness, bool vibrateAndroidIfNoSupport, bool rumble, float rumbleIntensity, float rumbleSharpness,
            int controllerID,
        ...
        public static void ContinuousHaptic(float intensity, float sharpness, float duration, HapticTypes fallbackOldiOS,
            MonoBehaviour mono,
